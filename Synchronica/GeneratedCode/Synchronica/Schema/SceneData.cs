...
public sealed class SceneData : Table {
  ...
  public GameObjectData GetObjects(GameObjectData obj, int j) { int o = __offset(6); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int ObjectsLength { get { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; } }
  ...
  public static void StartSceneData(FlatBufferBuilder builder) { builder.StartObject(2); }
